...
def calculate_demographic_data(print_data=True):
    ...
    # Calculate the percentage of >50K earners per country
    country_earning_stats = df.groupby('native-country')['salary'].value_counts(normalize=True).unstack()
    
    highest_earning_country = country_earning_stats['>50K'].idxmax()
    highest_earning_country_percentage = round(country_earning_stats['>50K'].max() * 100, 1)
